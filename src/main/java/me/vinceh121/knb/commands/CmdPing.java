...
public class CmdPing extends AbstractCommand {
	...
	protected void executeSync(final CommandContext ctx) {
		...
		ctx.getEvent()
				.getChannel()
				.sendMessage("I'd just like to interject for a moment. What you're referring to as Linux, is in fact, "
						...
						+ " useful by the GNU corelibs, shell utilities and vital system components comprising a full"
